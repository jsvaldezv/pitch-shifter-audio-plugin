...
{
    if (! verifyNumberOfChannels (numChannels) || (channels == numChannels))
        return;
...
void TDStretch::processSamples()
{
    ...
    */
    ...
    // DBG("sampleReq: " << sampleReq);
    // >0:3748 <0 6042(max),4548(one point example)
