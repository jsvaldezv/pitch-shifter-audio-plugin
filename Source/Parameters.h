...
inline juce::AudioProcessorValueTreeState::ParameterLayout createParameters()
{
    ...
    parameters.add (std::make_unique<juce::AudioParameterChoice> (juce::ParameterID (Algorithm, 1), Algorithm, juce::StringArray (Rubberband_Algorithm, WubVocoder_Algorithm, McPherson_Algorithm, Dysomni_Algorithm), 0));
