...
StftPitchShift::StftPitchShift (
    ...
    const bool chronometry) : StftPitchShift (std::make_shared<RFFT>(),
...
StftPitchShift::StftPitchShift (
    ...
    const double samplerate,
    const bool normalization,
    const bool chronometry) : StftPitchShift (fft,
                                              std::make_tuple (framesize, framesize),
                                              hopsize,
                                              samplerate,
                                              normalization,
...
StftPitchShift::StftPitchShift (
    ...
    const double samplerate,
    const bool normalization,
    const bool chronometry) : fft (fft),
                              framesize (framesize),
                              hopsize (hopsize),
